...
export default function Hero() {
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-[#F2F0ED] to-[#C7B7A7]" />

      {/* Flower — top-right (desktop only) */}
      <div className="absolute md:-top-32 md:-left-40 -left-30 md:w-[480px] w-[200px] h-[200px] md:h-[480px] opacity-25 pointer-events-none select-none   ">
      ...
      >
        ...
        >
          ...
          <Link
            href="/Cata"
            className="inline-flex items-center justify-center px-10 h-[52px] w-[240px] border border-black text-black text-[16px] bg-white/30 backdrop-blur-sm hover:bg-black hover:text-white transition-all duration-300"
            style={{ fontFamily: "'Poltawski Nowy', serif" }}
          >
            اكتشفي المجموعة
          </Link>
